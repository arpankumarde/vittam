    ...
    <div className="container mx-auto px-4 py-20">
      <div className="max-w-4xl mx-auto text-center mb-20">
        ...
        <p className="text-xl text-muted-foreground">
          We are on a mission to transform how financial institutions engage
        ...
        <div className="max-w-4xl mx-auto">
          ...
          <div className="bg-card border border-border/50 rounded-3xl p-12 shadow-sm">
            <p className="text-lg text-muted-foreground leading-relaxed text-center max-w-3xl mx-auto">
              To revolutionize the lending industry by making personal loans
              accessible, fast, and delightful. We believe every customer
              deserves a seamless experience, and every NBFC deserves technology
        ...
        <div className="grid md:grid-cols-3 gap-8 max-w-6xl mx-auto">
          <div className="bg-card border border-border/50 p-8 rounded-2xl shadow-sm text-center">
            ...
            <p className="text-muted-foreground">
              We believe in creating technology that enhances human connection,
              not replaces it. Our agents are designed to be helpful,
          ...
          <div className="bg-card border border-border/50 p-8 rounded-2xl shadow-sm text-center">
            ...
            <p className="text-muted-foreground">
              In the financial world, speed is currency. We reduce loan
              processing times from days to minutes without compromising on
              accuracy or risk.
            </p>
          </div>
          <div className="bg-card border border-border/50 p-8 rounded-2xl shadow-sm text-center">
            ...
            <p className="text-muted-foreground">
              We are constantly pushing the boundaries of what AI can do in the
              BFSI sector, setting new standards for automation and efficiency.
            </p>
          </div>
          <div className="bg-card border border-border/50 p-8 rounded-2xl shadow-sm text-center">
            <div className="h-14 w-14 bg-primary/10 rounded-full flex items-center justify-center mx-auto mb-6">
            ...
            <p className="text-muted-foreground">
              ...
              customer support. Every interaction matters.
            </p>
          </div>
          <div className="bg-card border border-border/50 p-8 rounded-2xl shadow-sm text-center">
            <div className="h-14 w-14 bg-primary/10 rounded-full flex items-center justify-center mx-auto mb-6">
            ...
            <p className="text-muted-foreground">
              Trust is the foundation of financial services. We build secure,
              compliant solutions that protect both our clients and their
              customers.
            </p>
          </div>
          <div className="bg-card border border-border/50 p-8 rounded-2xl shadow-sm text-center">
            ...
            <p className="text-muted-foreground">
              The AI landscape evolves rapidly. We stay ahead by continuously
              learning, iterating, and improving our solutions.
            </p>
          </div>
        </div>
      </section>
      ...
      <section className="mb-20">
        <div className="bg-secondary/30 rounded-3xl p-12 md:p-16">
          ...
          <div className="max-w-4xl mx-auto space-y-6 text-lg text-muted-foreground leading-relaxed">
            <p>
              Vittam was born out of a simple observation: while the world was
              moving towards instant gratification, getting a loan was still a
              painful, multi-day process involving endless paperwork and phone
              tag. We saw an opportunity to use advanced AI agents to bridge
              this gap, creating a seamless bridge between NBFCs and their
              customers.
            </p>
            <p>
              Founded in 2024, our team of AI researchers, financial services
              experts, and engineers came together with a shared vision: to make
              loan processing as fast and intuitive as ordering food online. We
              spent months understanding the pain points of both NBFCs and their
              customers, studying workflows, and designing an agentic system
              that could handle the complexity of financial decision-making.
            </p>
            <p>
      ...
      <section className="mb-20">
        ...
        <div className="grid md:grid-cols-2 gap-8 max-w-4xl mx-auto">
          ...
          <div className="bg-card border border-border/50 rounded-3xl p-8 shadow-sm text-center">
            ...
            <div className="flex gap-4 justify-center">
              <Link
                href="https://www.linkedin.com/in/priyamahato86"
                className="text-muted-foreground hover:text-primary transition-colors"
                target="_blank"
                rel="noopener noreferrer"
              >
      ...
      <section className="text-center">
        <div className="bg-primary/5 border border-primary/20 rounded-3xl p-12">
          ...
          <p className="text-lg text-muted-foreground mb-8 max-w-2xl mx-auto">
            ...
            passion for transforming financial services.
          </p>
