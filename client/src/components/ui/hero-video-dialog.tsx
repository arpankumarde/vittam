    ...
    <div className={cn("relative", className)}>
      ...
      >
        ...
        <div className="absolute inset-0 flex items-center justify-center group-hover:scale-100 scale-[0.9] transition-all duration-200 ease-out rounded-2xl">
          {/* Outer soft glow */}
          <div className="bg-white/30 flex items-center justify-center rounded-full backdrop-blur-md size-28">
            {/* Main white button */}
            <div
              className="
      ...
      "
            >
              <Play
                className="size-8 text-[#0D9488] fill-[#0D9488] group-hover:scale-105 scale-100 transition-transform duration-200 ease-out"
                style={{
